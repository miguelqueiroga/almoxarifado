package br.gov.ebserh.web.rest;

import br.gov.ebserh.config.Constants;
import br.gov.ebserh.AlmoxarifadoApp;
import br.gov.ebserh.domain.Authority;
import br.gov.ebserh.domain.User;
import br.gov.ebserh.repository.AuthorityRepository;
import br.gov.ebserh.repository.UserRepository;
import br.gov.ebserh.security.AuthoritiesConstants;
import br.gov.ebserh.service.MailService;
import br.gov.ebserh.service.dto.UserDTO;
import br.gov.ebserh.web.rest.errors.ExceptionTranslator;
import br.gov.ebserh.web.rest.vm.KeyAndPasswordVM;
import br.gov.ebserh.web.rest.vm.ManagedUserVM;
import br.gov.ebserh.service.UserService;
...
@SpringBootTest(classes = AlmoxarifadoApp.class)
