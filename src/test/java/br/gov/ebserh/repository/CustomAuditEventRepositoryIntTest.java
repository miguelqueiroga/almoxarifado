package br.gov.ebserh.repository;

import br.gov.ebserh.AlmoxarifadoApp;
import br.gov.ebserh.config.Constants;
import br.gov.ebserh.config.audit.AuditEventConverter;
import br.gov.ebserh.domain.PersistentAuditEvent;
...
import static br.gov.ebserh.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
